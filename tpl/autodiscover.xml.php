...
<Autodiscover xmlns="http://schemas.microsoft.com/exchange/autodiscover/responseschema/2006">
    ...
    <Response xmlns="http://schemas.microsoft.com/exchange/autodiscover/outlook/responseschema/2006a">
        ...
        <Account>
             ...
             */
            ?>
            <ServiceHome><?= $setting->getInfoUrl() ?></ServiceHome>
            ...
            <Protocol>
                 ...
                 */
                ?>
                <Server><?= $setting->getImapHost() ?></Server>
                ...
                if(null !== getEmail()) {
                    echo '<LoginName>' . getEmail() . '</LoginName>';
                }
                ?>
                ...
                ?>
                <DomainRequired><?= isOnOrOff($setting->getDomainRequired()) ?></DomainRequired>
                 ...
                 */
                if(null !== getEmail()) {
                    echo '<DomainName>' . explode('@', getEmail())[1] . '</DomainName>';
                }
                ?>
                 ...
                 * If unspecified, the default is set to on.
                 * */ ?>
                <SSL><?= isOnOrOff('SSL' === $setting->getImapSocket()) ?></SSL>
            ...
            <Protocol>
                <Type>SMTP</Type>
                <TTL><?= $setting->getTtl() ?></TTL>
                <Server><?= $setting->getSmtpHost() ?></Server>
                <Port><?= $setting->getSmtpPort() ?></Port>
                <DomainRequired><?= isOnOrOff($setting->getDomainRequired()) ?></DomainRequired>
                <SPA>off</SPA>
                <SSL><?= isOnOrOff('SSL' === $setting->getSmtpSocket()) ?></SSL>
                <AuthRequired>on</AuthRequired>
                <UsePOPAuth>on</UsePOPAuth>
                <SMTPLast>off</SMTPLast>
            </Protocol>
